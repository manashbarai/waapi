...
export const POST = async (req: NextRequest) => {
    try {
        ...
        // Log the Authorization header and request body
        ...
        const axiosResponse = await axios.post(api + '/vendor/whatsapp/sign-up', body, {
            headers: {
                'Content-Type': 'application/json',
                Origin: urlObj.href, // Use the extracted request origin
                Authorization: authHeader, // Use the retrieved Authorization header
            },
        });
